    ...
    <div class="header-top">
      <div class="container">
        ...
        <a href="tel:+01123456790" class="helpline-box">
          ...
          <div class="wrapper">
            <p class="helpline-title">For Further Information:</p>

            <p class="helpline-number">+017010101010</p>
          </div>
      ...
      <div class="container">
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-top">
            ...
            <a href="#" class="logo">
              <img src="./assets/images/log.png" alt="Be Traveller">
            </a>
    ...
    <article>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <h2 class="h1 hero-title">Be Traveller</h2>

          <p class="hero-text">
            Hola, this is Araf. To get knows more about world, get connected with me.
          </p>
      ...
      <section class="popular" id="destination">
        <div class="container">
          ...
          <p class="section-text">
            Most beautyful scenario of Bangladesh ever I explored
          </p>
            ...
            <li>
              <div class="popular-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-text">
                    Precious country and lifestyles
                  </p>
      ...
      <section class="package" id="package">
        <div class="container">
          ...
          <p class="section-text">
            You may get the best packages with reasonable price!
          </p>
      ...
      <section class="gallery" id="gallery">
        <div class="container">
          ...
          <h2 class="h2 section-title">Photo's From our Travel customers</h2>

          <p class="section-text">
            Here are some photos of our happy customers.
          </p>
      ...
      <section class="cta" id="contact">
        <div class="container">
          ...
          <div class="cta-content">
            ...
            <p class="section-text">
              For any query, just email us.
              Email- <b> yassinaraf@gmail.com </b>
            </p>
          </div>
    ...
    <div class="footer-top">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <p class="footer-text">
            Thank you for visiting us and giving best moments. :)
          </p>
        ...
        <div class="footer-contact">
          ...
          <ul>
            ...
            <li class="contact-item">
              ...
              <a href="tel:+88011223344" class="contact-link">+88011223344</a>
            </li>
        ...
        <div class="footer-form">
          ...
          <p class="form-text">
            Subscribe for more update & news !!
          </p>
